...
Audiocraft creates a log file, and you can tail the log file
instead of killing the services to view the logs

| Application | Log file                       |
|-------------|--------------------------------|
| Audiocraft  | /workspace/logs/audiocraft.log |
...
This is a custom packaged template for Audiocraft.
...
at Audiocraft! I'll try my best to help, but the
